...
for(i in 1:nrow(settings)){
  ...
  mod_w_oz <- do.call("deepregression", c(args, list(orthog_options=orthog_control(orthogonalize=TRUE))))
  mod_w_oz_25 <- do.call("deepregression", c(args, list(orthog_options=orthog_control(orthogonalize=TRUE))))
  mod_w_oz_50 <- do.call("deepregression", c(args, list(orthog_options=orthog_control(orthogonalize=TRUE))))
  mod_wo_oz <- do.call("deepregression", c(args, list(orthog_options=orthog_control(orthogonalize=FALSE))))
  mod_wo_oz_25 <- do.call("deepregression", c(args, list(orthog_options=orthog_control(orthogonalize=FALSE))))
  mod_wo_oz_50 <- do.call("deepregression", c(args, list(orthog_options=orthog_control(orthogonalize=FALSE))))
